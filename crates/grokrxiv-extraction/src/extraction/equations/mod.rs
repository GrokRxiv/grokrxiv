...
const SCHEMA_JSON: &str =
    include_str!("../../../../../agenthero/apps/grokrxiv/schemas/extraction/equations.schema.json");
...
mod agent_tests {
    ...
    impl AgentRunner for ScriptedRunner {
        ...
        async fn complete_with_tools(
            ...
            _spec: &AgentSpec,
            _messages: &[Message],
            _tools: &[agenthero_agent_runtime::ToolSpec],
            _ctx: &crate::extraction::ToolCtx<'_>,
    ...
    async fn equation_canon_run_via_mock_runner() {
        ...
        let ec = crate::extraction::ExtractionContext {
            workdir: tmp.path(),
            extract: &pe,
            semantic_ast: None,
