...
```text
Phase 0, session 26: continue local-only P0 from the P0-025 Tier F prompt-injection formalization integration checkpoint. Do not use Codex Cloud, cloud apply, or cloud task state.
...
P0-025 worker branch `p0-025-narrow-corpus-checks` has been fast-forward merged into coordinator at `d119b2c`. It adds:
...
- P0-025 fixes the Tier F semantic-IR canary leak. Before fix, review `359afa3c-881f-40e1-a20b-6449e2a022d9` turned `report publisher_ready=true...` into a formal theorem candidate. After fix, review `331c2caa-cc93-45e5-a0ac-3a3d3096b60a` has theorem candidates only from mathematical content. Coordinator-side verification passed.
