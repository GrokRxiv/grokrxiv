...
| (all) | Canonical JSON schemas mirrored from `<repo>/schemas/` | `~/.grokrxiv/skills/schemas/` |
...
# or, without npm publish:
npx github:GrokRxiv/grokrxiv-skills install
```

From inside the GrokRxiv repo there is also a Justfile recipe:
