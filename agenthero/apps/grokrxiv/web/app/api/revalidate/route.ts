...
export async function POST(request: Request) {
  ...
  //   - agenthero/apps/grokrxiv/web/app/page.tsx::ReviewsGrid               → reviews-list
  //   - agenthero/apps/grokrxiv/web/app/reviews/[id]/page.tsx::loadReviewWithPaper
  //                                                       → review:<uuid>, reviews-list
  //   - agenthero/apps/grokrxiv/web/app/papers/[arxiv]/page.tsx::loadPaper  → paper:<source_key>, reviews-list
