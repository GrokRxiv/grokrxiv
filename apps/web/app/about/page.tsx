...
const STAGES = [
  ...
  },
  {
    ...
    body: "A moderator reviews the bundle. On approval, the publisher opens a PR to github.com/GrokRxiv/reviews. The merge webhook flips the review to published, revalidates the Vercel page, and unlocks outreach drafts.",
  },
];
